    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button 
            ...
            className="bg-emerald-500 hover:bg-emerald-600 text-slate-900 font-bold py-2 px-6 rounded-xl transition-all shadow-lg shadow-emerald-500/20"
        >
            Start New Workout
        </button>
      </div>
      ...
      <div className="bg-blue-600/10 border border-blue-500/20 p-6 rounded-2xl flex items-center justify-between">
         ...
         <div className="flex items-center gap-6">
             ...
             <div className="flex gap-2">
                 <button onClick={() => updateWater(-1)} className="p-2 bg-slate-800 hover:bg-slate-700 rounded-lg text-white"><Minus size={16} /></button>
                 <button onClick={() => updateWater(1)} className="p-2 bg-blue-500 hover:bg-blue-600 rounded-lg text-white"><Plus size={16} /></button>
             </div>
         </div>
      </div>

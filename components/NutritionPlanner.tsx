    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700 shadow-xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
                ...
                <select 
                    ...
                    className="w-full bg-slate-900 border border-slate-700 text-white rounded-lg p-3 focus:ring-2 focus:ring-emerald-500 focus:outline-none"
                >
            ...
            <div className="space-y-2">
                ...
                <input 
                    ...
                    className="w-full bg-slate-900 border border-slate-700 text-white rounded-lg p-3 focus:ring-2 focus:ring-emerald-500 focus:outline-none placeholder-slate-500"
        ...
        <button 
          ...
          disabled={loading}
          className="w-full mt-6 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white font-bold py-4 px-6 rounded-xl transition-all shadow-lg shadow-blue-500/20 flex justify-center items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                 ...
                 <div className="flex gap-2">
                    <button 
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg border border-slate-700 transition-colors ${addedToCart ? 'bg-emerald-500/20 text-emerald-400' : 'bg-slate-800 hover:bg-slate-700 text-slate-300'}`}
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {plan.meals.map((meal, idx) => (
                    <div key={idx} className="bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden flex flex-col">
                        <div className="p-5 border-b border-slate-700 bg-slate-700/20">
                            <h4 className="text-xl font-bold text-white">{meal.name}</h4>
                            <div className="flex gap-3 mt-3">
                                <span className="flex items-center gap-1 text-xs text-blue-400 bg-blue-400/10 px-2 py-1 rounded">

...
import { Activity, Dumbbell, Utensils, MessageSquare, Menu, X, CalendarDays, ShoppingBag, User } from 'lucide-react';
    ...
    <>
      ...
      <div className="md:hidden fixed top-4 left-4 z-50">
        <button
          ...
          className="p-2 bg-slate-800 rounded-lg text-emerald-400 shadow-lg border border-slate-700"
        >

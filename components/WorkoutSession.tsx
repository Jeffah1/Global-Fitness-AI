...
import { Play, Pause, Square, CheckCircle, Clock, ChevronRight, Save } from 'lucide-react';
        ...
        <div className="max-w-3xl mx-auto h-[calc(100vh-100px)] flex flex-col bg-slate-900 relative">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button onClick={onCancel} className="p-2 text-slate-500 hover:text-white">
                ...
                <div className="bg-slate-800 rounded-3xl p-6 md:p-10 border border-slate-700 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex items-center justify-between bg-slate-900 p-4 rounded-xl border border-slate-700">
                             ...
                             <button 
                                onClick={logSet} 
                                className="px-6 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-lg font-bold border border-slate-600 transition-colors"
                             >
                                 Log Set
                             </button>
                        </div>
            ...
            <div className="fixed bottom-0 left-0 md:left-64 right-0 bg-slate-900 border-t border-slate-800 p-4 flex gap-4 z-30">
                <button 
                    ...
                    className="flex-1 bg-slate-800 hover:bg-slate-700 text-white font-bold py-4 rounded-xl transition-all flex items-center justify-center gap-2"
                >
                ...
                {currentExerciseIndex === plan.exercises.length - 1 ? (
                    <button 
                        ...
                        className="flex-[2] bg-[#00FF9C] hover:bg-[#00cc7d] text-slate-900 font-bold py-4 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#00FF9C]/20"
                    >
                    ...
                    <button 
                        onClick={handleNext}
                        className="flex-[2] bg-white hover:bg-slate-200 text-slate-900 font-bold py-4 rounded-xl transition-all flex items-center justify-center gap-2"
                    >
